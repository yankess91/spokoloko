  ...
  return (
    <div className="data-grid data-grid-appointments" role="table" aria-label={t('appointmentList.ariaLabel')}>
      <div className="data-grid-row data-grid-header" role="row">
        <span className="data-grid-cell" role="columnheader">{t('appointmentList.columns.appointment')}</span>
        <span className="data-grid-cell" role="columnheader">{t('appointmentList.columns.date')}</span>
        <span className="data-grid-cell" role="columnheader">{t('appointmentList.columns.client')}</span>
        <span className="data-grid-cell" role="columnheader">{t('appointmentList.columns.actions')}</span>
      </div>
      {appointments.map((appointment) => {
        ...
        return (
          ...
          >
            ...
            <div className="data-grid-cell" role="cell">
              <span className="data-grid-title">{client?.fullName ?? t('appointmentList.unknownClient')}</span>
              <span className="data-grid-meta">{client?.email || client?.phoneNumber || t('appointmentList.noContact')}</span>
            </div>
            <div className="data-grid-cell data-grid-actions" role="cell">
              ...
              <button type="button" className="ghost" onClick={() => onEdit?.(appointment)}>
                <EditOutlinedIcon fontSize="small" />
                {t('appointmentList.edit')}
              </button>
              <button
                type="button"
